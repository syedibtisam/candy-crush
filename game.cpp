...
void GameDisplay()/**/{
	...
	//Fire Gun
	for(int i=100;i<661;i+=90){
		for(int j=100;j<661;j+=90){
		//	cout<<i<<","<<j<<" ";
			DrawSquare( i , j ,80,colors[RED]);
		}
	//	cout<<endl;
	}
	//DrawSquare( 130 , 130 ,80,colors[RED]);
...
int main(int argc, char*argv[]) {
	...
	int width = 900, height = 1100; // i have set my window size to be 800 x 600
